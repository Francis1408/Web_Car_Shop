...
<body>
	...
	oci_bind_by_name($s, ":1", $_GET['detalhes']);
	$e = oci_execute($s);
	...
	echo "<h2>" . $row[0] . "</h2> <br>";
	echo "<h3> Placa: " . $row[4] . "</h2> <br>";
	echo "<h4> Data Publicação: " . $row[2] . "</h2> <br>";
	echo "<h3> VALOR: R$" . $row[3] . "</h2> <br>";

	echo "<h3> Detalhes Vendedor</h3><br>";
	echo "<h4> Nome: " . $row[10] . "</h2> <br>";
	echo "<h4> Email: " . $row[6] . "</h2> <br>";
	echo "<h4> Telefone: " . $row[7] . "</h2> <br>";
